...
public class JFrameAanpassen extends javax.swing.JFrame {
    ...
    private void CreateKlantGUI() {
        ...
        for (Klant kl : klanten) {
            String temp = Integer.toString(kl.getCode()) + " : " + kl.getNaam() + " : " + kl.getAdres();
    ...
    private void jBtAanpassenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAanpassenActionPerformed
        switch (soort) {
            case "Klant": {
                try {
                    int id = klanten.get(jCbSelect.getSelectedIndex()).getCode();
                    String naam, adres;
                    ...
                    main.getDatabase().update(new Klant(id, naam, adres));
                    JOptionPane.showMessageDialog(this, "De verandering(en) zijn correct toegepast.", "Informatie", JOptionPane.INFORMATION_MESSAGE);
            ...
            case "Onderdeel": {
                try {
                    ...
                    main.getDatabase().update(new Onderdeel(code, omsch, aantal, prijs));
                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(this, ex, "Fout", JOptionPane.ERROR_MESSAGE);
                }
                break;
