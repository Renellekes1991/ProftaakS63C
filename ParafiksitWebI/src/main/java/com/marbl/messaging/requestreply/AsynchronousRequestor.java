...
public class AsynchronousRequestor<REQUEST, REPLY> {
     ...
     * @param senderQueue
     */
    public AsynchronousRequestor(String factoryName, String requestSenderQueue, String replyReceiverQueue, IRequestReplySerializer<REQUEST, REPLY> serializer) throws Exception {
        super();
